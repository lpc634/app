...
def upgrade():
    """Create job_billing and expenses tables."""
    
    # Create job_billing table
    ...
    # Backfill job_billing for existing jobs
    # This creates a default billing configuration for all existing jobs
    connection = op.get_bind()
    
    # Insert default billing records for all existing jobs
