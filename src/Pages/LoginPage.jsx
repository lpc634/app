...
import BackgroundAurora from '../components/visuals/BackgroundAurora';
...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden" style={{ backgroundColor: "#0b0911" }}>
      {/* Aurora + Grain + Sparkles background */}
      <BackgroundAurora showParticles={true} />

      {/* Centered login card */}
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <Card className="v3-electric-card w-full max-w-md">
