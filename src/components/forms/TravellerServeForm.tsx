...
const schema = z.object({
  ...
  commercial_property: z.string().optional(),
  ...
  num_caravans: z.coerce.number().min(0).default(0),
...
function CountSelect({ name }: { name: string }) {
  const { setValue, watch } = useFormContext();
...
export default function TravellerServeForm({
  jobData,
            ...
            <div className="row">
              ...
              <div>
                <label
                  ...
                  style={{ display: "block", marginBottom: 6 }}
                >
                  What3Words location of campsite entrance:
          ...
          <section className="dashboard-card">
            ...
            <div className="row row-2">
              <div>
                ...
                <select className="v3-input" {...register("property_type")}>
                  <option value=""></option>
              ...
              <div>
                ...
                {watch("property_type") === "Car Park" && (
                  <>
                    ...
                    <select className="v3-input" {...register("car_park_type")}>
                      <option value=""></option>
                      <option>Retail Car Park</option>
                      <option>Business Car Park</option>
                      <option>Trading estate</option>
                    </select>
                  </>
                )}
                {watch("property_type") === "Open Land" && (
                  <>
                    ...
                    <select className="v3-input" {...register("field_type")}>
                      <option value=""></option>
                      <option>Farm Land</option>
                      <option>Council Land</option>
                      <option>Park</option>
                    </select>
                  </>
                )}
            ...
            <div className="row row-2">
              <div>
                <YesNo
                  name="aggressive"
                  label="Are the travellers aggressive?"
                />
                <AnimatePresence>
                  {aggressive && (
                    <motion.div
            ...
            <div style={{ marginTop: 10 }}>
              <div className="row row-2">
                <div>
                  <div className="h2" style={{ marginBottom: 6 }}>
                    Number Of Caravans:<span className="label-star">*</span>
                  </div>
                  <CountSelect name="num_caravans" />
                </div>
                <div>
                  <div className="h2" style={{ marginBottom: 6 }}>
